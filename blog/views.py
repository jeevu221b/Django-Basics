...
from blog.requirements.notificationSender import notifier
from blog.requirements.writeLogs import infoLogs
from blog.requirements.writeLogs import errorsLogs
from blog.requirements.loggedUser import getCurrentUser
...
def blogHome(request):
    cronos()
    return HttpResponse("<h1>This is the homepage of the blog!</h1>") 
